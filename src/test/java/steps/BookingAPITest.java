...
public class BookingAPITest {
    ...
    public void user_creates_booking_with_post_api_call_with_data(DataTable dataTable) {
        ...
        bookingPayload.setTotalprice(Integer.parseInt(totalPrice));
         ...
         bookingPayload.setAditionalneeds(additionalNeeds);
        ...
        response = given().baseUri(ConfigReader.getProperty("BookingAPIBaseUrl"))
                ...
                .and().body(bookingPayload) // POJO -> Json ----> SERILIAZATION
                .when().post("/booking");
    ...
    public void user_updates_booking_with_put_api_call_with_data(DataTable dataTable) {
        ...
        response = given().baseUri(ConfigReader.getProperty("BookingAPIBaseUrl"))
                ...
                .and().body("{\n" +
                        ...
                        "}").and().log().all().when().put("/booking/" + id);
    ...
    public void user_validates_updated_data_matches_with_response_of_get_call() {
        Booking bookingRespopnse= response.body().as(Booking.class);
        Assert.assertEquals(updatedData.get("firstname"),bookingRespopnse.getFirstname());
        Assert.assertEquals(updatedData.get("checkin"),bookingRespopnse.getBookingdates().getCheckin());
        Assert.assertEquals(updatedData.get("checkout"),bookingRespopnse.getBookingdates().getCheckout());
    }
